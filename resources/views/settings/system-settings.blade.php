...
<section class="section">
    <form class="form" action="{{ url('set_settings') }}" data-parsley-validate method="POST" id="setting_form"
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row form-group mandatory">
                        ...
                        <div class="col-sm-4">
                            <input name="company_tel1" type="text" class="form-control" placeholder="Contact Number 1"
                                maxlength="10" onKeyDown="if(this.value.length==16 && event.keyCode!=8) return false;"
                                value="{{ system_setting('company_tel1') != '' ? system_setting('company_tel1') : '' }}">

                        </div>
                        <label class="col-sm-2 form-label-mandatory">{{ __('Contact Number 2') }}</label>
                        <div class="col-sm-4">
                            <input name="company_tel2" type="text" class="form-control" placeholder="Contact Number 2"
                                maxlength="10" onKeyDown="if(this.value.length==16 && event.keyCode!=8) return false;"
                    ...
                    <div class="form-group mandatory row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="company_address" class="form-control" id=""
                                rows="3">{{ system_setting('company_address') != '' ? system_setting('company_address') : '' }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    <div class="form-group mandatory row">
                        ...
                        <label class="col-sm-2 form-label-mandatory">{{ __('Facebook Id') }}</label>
                        <div class="col-sm-4">
                        ...
                        <label class="col-sm-2 form-label-mandatory">{{ __('Instagram Id') }}</label>
                        <div class="col-sm-4">
                    ...
                    <div class="row form-group mandatory">
                        <label class="col-sm-2 form-label-mandatory">{{ __('Twitter Id') }}</label>
                        <div class="col-sm-4">
                        ...
                        <label class="col-sm-2 form-label-mandatory">{{ __('Pintrest Id') }}</label>
                        <div class="col-sm-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group mandatory row mt-3">
                    <label class="col-sm-2 form-label-mandatory  mt-5">{{ __('Paypal Business ID') }}</label>
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-5">{{ __('Paypal Webhook URL') }}</label>
                    <div class="col-sm-4 mt-5">
                    ...
                    <div class="col-sm-2 col-md-4 col-xs-12   mt-3 ">
                        <div class="form-check form-switch  ">
                            ...
                            <label class="form-check-label mandatory" for="switch_sandbox_mode"></label>
                        </div>
                    </div>
                    <label class="col-sm-2 form-check-label mandatory  mt-3 " id='lbl_paypal'>{{
                        system_setting('paypal_gateway')
                        != '' ? (system_setting('paypal_gateway') == 0 ? 'Disable' : 'Enable') : 'Disable' }}</label>
                    <div class="col-sm-2 col-md-4 col-xs-12   mt-3 ">
                        <div class="form-check form-switch  ">
                            ...
                            <label class="form-check-label mandatory" for="switch_paypal_gateway"></label>
                        </div>
                    </div>
                ...
                <div class="form-group mandatory row mt-3">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-5">{{ __('Razorpay key') }}</label>
                    <div class="col-sm-4 mt-5">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-5">{{ __('Razorpay Webhook URL') }}</label>
                    <div class="col-sm-4 mt-5">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Razorpay Secret') }}</label>
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-3" id='lbl_razorpay'>{{
                        system_setting('razorpay_gateway') != '' ? (system_setting('razorpay_gateway') == 0 ? 'Disable'
                    ...
                    <div class="col-sm-2 col-md-4 col-xs-12  mt-3">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label mandatory" for="switch_razorpay_gateway"></label>
                        </div>
                    </div>
                ...
                <div class="form-group mandatory row mt-5">


                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Paystack Secret key') }}</label>
                    <div class="col-sm-4 mt-3">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Paystack Webhook URL') }}</label>
                    <div class="col-sm-4 mt-3">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Paystack Currency Symbol')
                        }}</label>
                    ...
                    <label class="col-sm-2 form-check-label mandatory  mt-3" id='lbl_paystack'>{{
                        system_setting('paystack_gateway') != '' ? (system_setting('paystack_gateway') == 0 ? 'Disable'
                        : 'Enable') : 'Disable' }}</label>
                    <div class="col-sm-2 col-md-4 col-xs-12  mt-3">
                        ...
                        <div class="form-check form-switch ">
                            ...
                            <input class="form-check-input" type="checkbox" role="switch" class="switch-input" name='op'
                                {{ system_setting('paystack_gateway')=='1' ? 'checked' : '' }}
                                id="switch_paystack_gateway">

                        </div>
                    </div>
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Paystack Public key') }}</label>
                    <div class="col-sm-4 mt-3">
                ...
                <div class="form-group mandatory row mt-5">
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Stripe publishable key') }}</label>
                    <div class="col-sm-4 mt-3">
                    ...
                    <label class="col-sm-2 form-label-mandatory  mt-3">{{ __('Stripe Webhook URL') }}</label>
                    <div class="col-sm-4 mt-3">
                    ...
                    <label class="col-sm-2 form-check-label mandatory  mt-3">{{ __('Stripe Currency Symbol') }}</label>
                    ...
                    <div class="col-sm-4 mt-3">
                        ...
                        <select name="stripe_currency" id="stripe_currency" class="select2 form-select form-control-sm">
                            ...
                            <option value={{ $value }} {{ system_setting('stripe_currency')==$value ? 'selected' : ''
                                }}>
                                {{ $value }}</option>
                            @endforeach
                        </select>
                    ...
                    <label class="col-sm-2 form-check-label mandatory  mt-3" id='lbl_stripe'>{{
                        system_setting('stripe_gateway')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group mandatory row mt-3">
                    ...
                    <div class="col-sm-2 col-md-4 col-xs-12 ">
                        <select name="default_language" id="default_language"
                            ...
                            {{ $row }}
                            <option value="{{ $row->code }}" {{ system_setting('default_language')==$row->code ?
                                'selected' : '' }}>
                                {{ $row->name }}
                            </option>
                            @endforeach
                ...
                <div class="form-group mandatory row mt-3">
                    ...
                    <div class="col-sm-4">
                        <input name="unsplash_api_key" type="text" class="form-control" placeholder="Place API Key"
            ...
            <div class="card-body">
                ...
                <div class="form-group mandatory row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10 col-xs-12 ">
                        <textarea name="fcm_key" class="form-control" rows="3" data-parsley-required="true"
                            placeholder="Fcm Key">{{ system_setting('fcm_key') != '' ? system_setting('fcm_key') : '' }}</textarea>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group mandatory row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10 col-xs-12">
                        <textarea name="iframe_link" class="form-control" rows="3" data-parsley-required="true"
        ...
        <div class="col-12 d-flex justify-content-end">
            <button type="submit" name="btnAdd" value="btnAdd" class="btn btn-primary me-1 mb-1">{{
                __('Save') }}</button>
        </div>
